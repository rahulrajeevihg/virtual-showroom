          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6" role="list" aria-label="Product list">
            {filteredProducts.map((product) => (
              <article
                ...
                className="group relative bg-black border-2 border-white/20 rounded-2xl p-6 hover:border-white/60 transition-all duration-500 hover:scale-[1.02] overflow-hidden"
                role="listitem"
              >
                {/* Stock Badge */}
                ...
                <Link href={`/product/${product.item_code}`}>
                  <div className="bg-white/10 rounded-xl h-64 mb-4 flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-500">
                    {product.image ? (
                      <img
                ...
                <div className="space-y-2">
                  ...
                  <Link href={`/product/${product.item_code}`}>
                    <h3 className="text-base font-bold text-white hover:text-white/80 transition line-clamp-2 min-h-[3rem]">
                      {product.item_name}
                    </h3>
                  </Link>
                  {product.brand && (
